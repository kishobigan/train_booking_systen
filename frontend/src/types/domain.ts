...
export interface User { id: string; email: string; fullName: string; role: Role; mustChangePassword?: boolean; assignedTrainIds?: string[]; assignedJourneyIds?: string[]; assignedStationIds?: string[]; scope?: {assignedTrainIds:string[];assignedJourneyIds:string[];assignedStationIds:string[]} }
